        ...
        <div class="row nav-inner">
            ...
            <ul class="nav-list">
                @if ( Request::is('/') )
                    ...
                    {{-- </li> --}}
                    <li class="nav-list-item"><a href="#" data-section-id="previews-section" class="nav-list-link">Материалы</a></li>
                    <li class="nav-list-item"><a href="#" data-section-id="email-section" class="nav-list-link">Почта</a></li>
                    @if ( ! Auth::check() )
                        <li class="nav-list-item"><a href="#login" class="nav-list-link normal">Войти</a></li>
                        <li class="nav-list-item"><a href="#register" class="nav-list-link normal">Регистрация</a></li>
                    @else
